...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,356 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-18 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [faceclaw](https://github.com/jimrandomh/faceclaw) ⭐ 65 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-18 - Native desktop dashboard for driving the G2 display outside the WebView.
...
* [Mentra-Bluetooth-SDK-Starter-Kit](https://github.com/Mentra-Community/Mentra-Bluetooth-SDK-Starter-Kit) ⭐ 15 | 🐛 28 | 📅 2026-09-18 - Apache-2.0 native BLE SDK starter kit for connecting an Android, iOS, or React Native app to smart glasses, including the G2, powered by MentraOS.
...
* [mentra-bluetooth-sdk-ios](https://github.com/Mentra-Community/mentra-bluetooth-sdk-ios) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2026-09-18 - Swift Package Manager distribution of the Mentra Bluetooth SDK for iOS.
...
* [even-messages](https://github.com/thibautrey/even-messages) ⭐ 13 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-15 - Unified inbox client bringing messages from multiple services to the glasses.
...
* [notion-ultimate-brain-even-g2](https://github.com/hofstede-matheus/notion-ultimate-brain-even-g2) ⭐ 0 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Ultimate Brain Notion template surfaced as a G2 interface.
...
* [CyberNews](https://github.com/zakpatrik/CyberNews-evenrealities-app) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - Merges four cybersecurity news feeds into one scrollable headline list.
...
* [hermes-even-hub-app](https://github.com/huntsyea/hermes-even-hub-app) ⭐ 4 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - G2 WebView client that drives locally running Hermes agents hands-free with voice and streaming responses.
...
* [hermes-evenhub-bridge](https://github.com/huntsyea/hermes-evenhub-bridge) ⭐ 2 | 🐛 13 | 🌐 Python | 📅 2026-09-14 - Python adapter exposing the G2 as a Hermes agent platform.

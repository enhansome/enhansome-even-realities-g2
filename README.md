...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,362 | 🐛 800 | 🌐 TypeScript | 📅 2026-09-22 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [Glyph](https://github.com/gabrielevierti/glyph) ⭐ 17 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Graphics and UI framework for G2 apps that renders a full framebuffer and sends only the changed tiles.
* [Mentra-Bluetooth-SDK-Starter-Kit](https://github.com/Mentra-Community/Mentra-Bluetooth-SDK-Starter-Kit) ⭐ 15 | 🐛 28 | 📅 2026-09-22 - Apache-2.0 native BLE SDK starter kit for connecting an Android, iOS, or React Native app to smart glasses, including the G2, powered by MentraOS.
...
* [mentra-bluetooth-sdk-ios](https://github.com/Mentra-Community/mentra-bluetooth-sdk-ios) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2026-09-22 - Swift Package Manager distribution of the Mentra Bluetooth SDK for iOS.
...
* [even-g2-protocol](https://github.com/i-soxi/even-g2-protocol) ⭐ 184 | 🐛 7 | 📅 2026-01-20 - Community effort to reverse-engineer the G2 BLE protocol, with characteristic mapping and Python examples.
...
* [g2flash](https://github.com/jimrandomh/g2flash) ⭐ 32 | 🐛 3 | 🌐 C | 📅 2026-09-20 - Custom firmware for the G2 that adds compressed image transfer, full-screen 576x288 single-image support, per-lens stereo output, and beeper tones, paired with matching custom send-side software.
...
* [damage-wm](https://github.com/expectbugs/damage-wm) ⭐ 1 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-22 - From-scratch window manager and compositor for the G2 on custom firmware, batching per-frame screen damage into a single BLE message, with a measured latency curve replacing the modeled numbers.
...
* [Applied Resonance](https://github.com/cwklurks/applied-resonance) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Learns how a healthy machine sounds through the G2 microphone and warns you when the sound changes.
...
* [CyberNews](https://github.com/zakpatrik/CyberNews-evenrealities-app) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - Merges four cybersecurity news feeds into one scrollable headline list.
...
* [Card Pack](https://github.com/tntpsu/CardPack) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - Seven classic card games, including Hearts, Spades, and Cribbage, for the G2.
...
* [cos-glasses-server](https://github.com/ukaoma/cos-glasses-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - Self-hosted heads-up-display server that drives the G2 from a local Claude Code CLI.
* [Cue](https://github.com/tntpsu/Cue) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - Real-time conversation coach suggesting responses live, powered by Deepgram speech-to-text and Claude.

...
* [everything-evenhub](https://github.com/even-realities/everything-evenhub) ⭐ 66 | 🐛 14 | 📅 2026-08-20 - Official developer kit bundling the Even Hub SDK, CLI, simulator, and documentation for building G2 apps.
* [Even Hub Starter Templates](https://github.com/even-realities/evenhub-templates) ⭐ 45 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-07 - Four official scaffolds to clone and run: minimal, ASR, image, and text-heavy.
...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,320 | 🐛 774 | 🌐 TypeScript | 📅 2026-08-22 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [faceclaw](https://github.com/jimrandomh/faceclaw) ⭐ 18 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-21 - Native desktop dashboard for driving the G2 display outside the WebView.
...
* [ffs-os](https://github.com/yonif8/ffs-os) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22 - Clean-room Swift BLE driver and glasses OS for the G2, independent of the official stack.
...
* [notion-ultimate-brain-even-g2](https://github.com/hofstede-matheus/notion-ultimate-brain-even-g2) ⭐ 0 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-19 - Ultimate Brain Notion template surfaced as a G2 interface.
...
* [HeadLenss](https://github.com/takashicompany/headlenss) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-22 - Drive Claude Code on your PC by voice from the G2, plus tmux control from a phone browser.

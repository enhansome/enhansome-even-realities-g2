...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,363 | 🐛 802 | 🌐 TypeScript | 📅 2026-09-23 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [faceclaw](https://github.com/jimrandomh/faceclaw) ⭐ 69 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-23 - Native desktop dashboard for driving the G2 display outside the WebView.
...
* [Mentra-Bluetooth-SDK-Starter-Kit](https://github.com/Mentra-Community/Mentra-Bluetooth-SDK-Starter-Kit) ⭐ 15 | 🐛 28 | 📅 2026-09-23 - Apache-2.0 native BLE SDK starter kit for connecting an Android, iOS, or React Native app to smart glasses, including the G2, powered by MentraOS.
...
* [even-notifications](https://github.com/ryanadiaz/even-notifications) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-13 - Draws simulated notification popup overlays so you can design around them without a live phone notification.
...
* [mentra-bluetooth-sdk-ios](https://github.com/Mentra-Community/mentra-bluetooth-sdk-ios) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2026-09-23 - Swift Package Manager distribution of the Mentra Bluetooth SDK for iOS.
...
* [g2flash](https://github.com/jimrandomh/g2flash) ⭐ 33 | 🐛 3 | 🌐 C | 📅 2026-09-23 - Custom firmware for the G2 that adds compressed image transfer, full-screen 576x288 single-image support, per-lens stereo output, and beeper tones, paired with matching custom send-side software.
...
* [even-my-news-hub](https://github.com/r-tkbyc/even-my-news-hub) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-09-23 - Personal news hub for the G2, built as a dependency-free HTML, CSS, and JavaScript app.
...
* [CyberNews](https://github.com/zakpatrik/CyberNews-evenrealities-app) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Merges four cybersecurity news feeds into one scrollable headline list.
...
* [cos-glasses-server](https://github.com/ukaoma/cos-glasses-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Self-hosted heads-up-display server that drives the G2 from a local Claude Code CLI.

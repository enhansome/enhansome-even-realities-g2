...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,371 | 🐛 802 | 🌐 TypeScript | 📅 2026-09-26 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [faceclaw](https://github.com/jimrandomh/faceclaw) ⭐ 72 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-26 - Native desktop dashboard for driving the G2 display outside the WebView.
...
* [Mentra-Bluetooth-SDK-Starter-Kit](https://github.com/Mentra-Community/Mentra-Bluetooth-SDK-Starter-Kit) ⭐ 15 | 🐛 28 | 📅 2026-09-26 - Apache-2.0 native BLE SDK starter kit for connecting an Android, iOS, or React Native app to smart glasses, including the G2, powered by MentraOS.
...
* [mentra-bluetooth-sdk-ios](https://github.com/Mentra-Community/mentra-bluetooth-sdk-ios) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2026-09-26 - Swift Package Manager distribution of the Mentra Bluetooth SDK for iOS.
...
* [g2flash](https://github.com/jimrandomh/g2flash) ⭐ 34 | 🐛 3 | 🌐 C | 📅 2026-09-25 - Custom firmware for the G2 that adds compressed image transfer, full-screen 576x288 single-image support, per-lens stereo output, and beeper tones, paired with matching custom send-side software.
...
* [CyberNews](https://github.com/zakpatrik/CyberNews-evenrealities-app) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-26 - Merges four cybersecurity news feeds into one scrollable headline list.
...
* [EvenFoundryVTT](https://github.com/Aiacos/EvenFoundryVTT) ⭐ 0 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-26 - D\&D 5e on the G2 and R1 ring, synced with FoundryVTT via a phosphor-green tactical HUD.
...
* [cos-glasses-server](https://github.com/ukaoma/cos-glasses-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-26 - Self-hosted heads-up-display server that drives the G2 from a local Claude Code CLI.
...
* [hermes-evenhub-bridge](https://github.com/huntsyea/hermes-evenhub-bridge) ⭐ 2 | 🐛 14 | 🌐 Python | 📅 2026-09-26 - Python adapter exposing the G2 as a Hermes agent platform.

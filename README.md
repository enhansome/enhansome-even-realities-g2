...
* [everything-evenhub](https://github.com/even-realities/everything-evenhub) ⭐ 76 | 🐛 25 | 📅 2026-08-20 - Official developer kit bundling the Even Hub SDK, CLI, simulator, and documentation for building G2 apps.
...
* [MentraOS](https://github.com/Mentra-Community/MentraOS) ⭐ 2,353 | 🐛 791 | 🌐 TypeScript | 📅 2026-09-17 - Open-source smart-glasses OS and app SDK that drives the G2, among other glasses, over BLE.
...
* [faceclaw](https://github.com/jimrandomh/faceclaw) ⭐ 65 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-13 - Native desktop dashboard for driving the G2 display outside the WebView.
...
* [Mentra-Bluetooth-SDK-Starter-Kit](https://github.com/Mentra-Community/Mentra-Bluetooth-SDK-Starter-Kit) ⭐ 15 | 🐛 28 | 📅 2026-09-17 - Apache-2.0 native BLE SDK starter kit for connecting an Android, iOS, or React Native app to smart glasses, including the G2, powered by MentraOS.
...
* [mentra-bluetooth-sdk-ios](https://github.com/Mentra-Community/mentra-bluetooth-sdk-ios) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2026-09-17 - Swift Package Manager distribution of the Mentra Bluetooth SDK for iOS.
...
* [g2flash](https://github.com/jimrandomh/g2flash) ⭐ 31 | 🐛 3 | 🌐 C | 📅 2026-09-13 - Custom firmware for the G2 that adds compressed image transfer, full-screen 576x288 single-image support, per-lens stereo output, and beeper tones, paired with matching custom send-side software.
...
* [g2-thai](https://github.com/rayriffy/even-g2-thai) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Patches G2 firmware with a Thai bitmap font so the glasses render Thai text, with documented checksum verification and a rebase playbook.
...
* [even-messages](https://github.com/thibautrey/even-messages) ⭐ 13 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-15 - Unified inbox client bringing messages from multiple services to the glasses.
...
* [CyberNews](https://github.com/zakpatrik/CyberNews-evenrealities-app) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - Merges four cybersecurity news feeds into one scrollable headline list.
...
* [cos-glasses-server](https://github.com/ukaoma/cos-glasses-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - Self-hosted heads-up-display server that drives the G2 from a local Claude Code CLI.
